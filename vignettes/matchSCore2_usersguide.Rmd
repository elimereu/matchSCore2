...
By using a reference dataset in which the cellular type of individual cells is defined and gene markers are computed, matchSCore2 trains a multinomial logistic model to classify unknown cells in new datasets from similar tissues. The method consists in the following steps:
...
2. For each cell in the reference, a cell type signature score is assigned.
