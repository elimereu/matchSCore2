...
data <- FindVariableGenes(object = data, mean.function = ExpMean, dispersion.function = LogVMR, x.low.cutoff = 0.08, x.high.cutoff = 3, y.cutoff = 1.5)
...
data <- FindClusters(object = data, reduction.type = "pca", dims.use = 1:6, resolution = 0.5, print.output = 0, save.SNN = TRUE,force.recalc=TRUE)
table(data@ident)
# 0   1   2   3   4 
# 627 434 239 116  92 
