...
data <- FindVariableGenes(object = data, mean.function = ExpMean, dispersion.function = LogVMR, x.low.cutoff = 0.03, 
...
table(data@ident)
0   1   2   3   4   5   6   7 
392 374 329 317 243 233 178 125 
