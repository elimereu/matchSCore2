...
data <- FindClusters(object = data, reduction.type = "pca", dims.use = 1:8, resolution = 0.3, print.output = 0, save.SNN = TRUE,force.recalc=TRUE)
table(data@ident)
0   1   2   3   4   5   6 
794 442 326 297 183 132  87
...
levels(data@ident) <- c("HEK cells 1","HEK cells 2","CD14+ and FCGR3A+ monocytes","CD8+ T cells and NK","CD4+ cells","HEK cells 3","B cells")
