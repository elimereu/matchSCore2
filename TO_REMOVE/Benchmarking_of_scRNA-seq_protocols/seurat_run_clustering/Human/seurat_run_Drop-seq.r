...
#20.0   407.0   656.0   957.1   933.0 12680.0  
...
data <- CreateSeuratObject(raw.data = cd.sparse, min.cells = 5, min.genes = q, project = "Drop-seq")
dim(data@data)
#23075  2286
...
data <- FindVariableGenes(object = data, mean.function = ExpMean, dispersion.function = LogVMR, x.low.cutoff = 0.28, x.high.cutoff = 1.7, y.cutoff = 0.5)
...
levels(data@ident) <- c("Cytotoxic T cells","HEK cells","NK and Cytotoxic T cells","B cells","CD14+ Monocytes")