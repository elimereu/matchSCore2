...
data <- FindClusters(object = data, reduction.type = "pca", dims.use = 1:8, resolution = 0.7, print.output = 0, save.SNN = TRUE,force.recalc=TRUE)
table(data@ident)
0   1   2   3   4   5   6 
234 133 114  91  67  55  42
...
levels(data@ident) <- c("CD4 T cells 1","NK cells","CD4 T cells 2","CD8+ T cells","B cells","CD14 and FCGR3A Monocytes","HEK cells")
