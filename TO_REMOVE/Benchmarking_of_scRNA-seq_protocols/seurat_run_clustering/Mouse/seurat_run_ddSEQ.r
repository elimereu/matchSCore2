...
#49.0   164.8   412.0   970.4  1274.8  9832.0
...
data <- FindVariableGenes(object = data, mean.function = ExpMean, dispersion.function = LogVMR, x.low.cutoff = 0.28, 
...
data <- FindClusters(object = data, reduction.type = "pca", dims.use = 1:11, resolution = 0.7, print.output = 0, save.SNN = TRUE,force.recalc=TRUE)
table(data@ident)
0   1   2   3   4   5 
163 162  71  61  48  26 
...
tsne1<-TSNEPlot(object = data,group.by="res.0.7")
...
dir.create("out_Seurat/plots")
png(file="out_Seurat/plots/TSNE_clusters.png",width = 10, height = 8,units = 'in', res = 300)
tsne
dev.off()
