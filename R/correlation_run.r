...
correlation_run <- function(raw,nnet,cell_types,batch,n=NULL,genes=NULL){
  ...
  lapply(corr,function(x) corrplot(x, method = "square",order = "hclust",hclust.method = "ward.D2",type="upper",col = col(100),tl.col="black",tl.cex=2,number.cex = 20))
