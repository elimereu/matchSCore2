...
# library(org.Hs.eg.db)
  ...
  ks.test = new(go.score.class, testStatistic = topGO::GOKSTest,
...
for (clus in levels(cluster)) {
  ...
  t = topGO::GenTable(go.data, weightKS = ks.results, numChar = 512,
  ...
  return(list(GOenrich=tables,genes_byGO=genes_byGO))
}
