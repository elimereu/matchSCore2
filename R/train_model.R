...
#' @param prop The proportion of the reference data used to train the model. Default=0.5. 
#' @param p.threshold Probability threshold to consider a cell classified. Default=0.65.
#' @return A multinomial fitted model as in nnet package. 
#' @export
#' @examples
#' 
